...
test("Data is correctly transferred from the UI elements to the generateChartImg function (Without using getElementByID", async function() {
    initDomFromFiles(`${__dirname}/line.html`,`${__dirname}/line.js`)
...
expect(generateChartImgSpy).toHaveBeenCalledWith("line", [{x:"0",y:"0"}, {x:"10",y:"5"}, {x:"20",y:"10"}], "Cats", "Dogs", "Cats vs Dogs", "#47d5f5")
